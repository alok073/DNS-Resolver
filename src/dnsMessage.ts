...
import { IDnsHeader, IDnsMessage, IQuestion, IResourceRecord, DnsMessageArgs } from './types';
import {
...
class DnsMessage implements IDnsMessage {
    ...
    constructor({ header = undefined, questions = [], answers = [], authority = [], additional = [] }: DnsMessageArgs) {
      if (header === undefined) {
